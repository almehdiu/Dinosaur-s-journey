...
void reset(){
	...
	drawstring(600.0,1500.0,1.0,"START AGAIN");
...
void render( void ){
	...
	for(i=0;i<2000;i+=400)
	{
		...
		glVertex2f(0+i,1500);
		glVertex2f(100+i,1800);
		glVertex2f(200+i,1500);
		glEnd();
	}
	for(i=0;i<2000;i+=400)
	{
		glBegin(GL_TRIANGLES);
		glVertex2f(200+i,1500);
		glVertex2f(300+i,1700);
		glVertex2f(400+i,1500);
		glEnd();
	}
	glColor3f(1,0.3,0);
	...
	{
		theta=j*3.14/180;
		glVertex2f(1815+85*cos(theta),1620+85*sin(theta));
	}
	glEnd();
	if(u<2000)u++;
	...
	glBegin(GL_TRIANGLES);
        ...
        glVertex2f(1743,1672);
        glVertex2f(1888,1670);
    glEnd();
	...
	glColor3f(1.0f,1.0f,1.0f);
	setFont(GLUT_BITMAP_HELVETICA_12);
	drawstring(600.0,1120.0,1.0,"LEVEL 1:  DESERT");
    glFlush();
}
...
void render1( void ){
	...
	glColor3f(1.0f,1.0f,1.0f);
	setFont(GLUT_BITMAP_HELVETICA_12);
	drawstring(600.0,1120.0,1.0,"LEVEL 2:  GREENLAND");
    glFlush();
}
...
int main( int argc , char** argv ){
	...
	{
       case 1:
		glutCreateWindow("DINOSAUR JUMPING: DESERT");
		    setup();
		    glutDisplayFunc(render);
			break;
	    case 2:
		glutCreateWindow("DINOSAUR JUMPING: GREENLAND");
		      setup1();
